      ...
      <div v-if="! resourceForm" class="add">
        <q-btn v-if="$q.screen.gt.xs"
          ...
          <q-tooltip :offset="[5, 5]"
                     content-class="bg-amber text-black shadow-4">{{ $t("dynamicTable.addToolTip", { item: name }) }}</q-tooltip>
        </q-btn>
      </div>
    </div>
    <q-card>
      <q-toolbar>
        ...
        <q-btn flat round dense
          ...
          <q-tooltip :offset="[5, 5]"
                     content-class="bg-amber text-black shadow-4">{{ $t("dynamicTable.refreshToolTip") }}</q-tooltip>
        </q-btn>
